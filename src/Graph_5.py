# -*- coding: utf-8 -*-
"""
Created on Wed May  3 16:11:40 2023
...
class Node:
    ...
    def __init__(self, _id):
       ...
       self.willingness_to_compute = HITS.UNCERTAIN_BELIEF
...
def get_avg_wtc(nodes):
    return sum(n.willingness_to_compute for n in nodes) / len(nodes)
